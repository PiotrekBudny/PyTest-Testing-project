class LoginPageAssertions:
    ...
    def assert_that_invalid_login_flash_message_is_displayed(self):
        ...
        assert "Your username is invalid!" in self.page.flash_messages.text, ("Flash message for invalid login not as "
                                                                              "expected")
    ...
    def assert_that_user_has_logged_out(self):
        ...
        assert "You logged out of the secure area!" in self.page.flash_messages.text, ("Logout failed or flash message "
                                                                                       "not as expected")
