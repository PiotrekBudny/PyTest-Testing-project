...
class ApiAssertions:
    ...
    def assert_post_response(self, expected_post_id):
        ...
        assert get_post_response.user_id == 1, "Expected 'userId' to be present in the response and equal to 1"
    ...
    def assert_create_post_response(self, create_post_request):
        ...
        assert create_post_response.user_id == create_post_request.userId, (
